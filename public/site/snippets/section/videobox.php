...
?>
<div class="Videobox [ Element ]" id="S<?php echo $section->hash(); ?>"  data-view="VideoView">
	<div class="Videobox__background">
			<iframe width="420" height="315" src="https://www.youtube.com/embed/<?php echo $section->videoid(); ?>?autoplay=0&enablejsapi=1&loop=1&showinfo=0&controls=0&enablejsapi=1"></iframe>
	</div>
